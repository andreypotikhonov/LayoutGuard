...
public sealed class AppSettings
{
    ...
    public string BrokenRussianLetters { get; set; } = "прэ";
    // These are the same physical keys as Russian “прэ” on a US layout.
    public string BrokenEnglishLetters { get; set; } = "gh'";
